#ifndef CNR_OPEN_LOOP_POSVEL_CONTROLLER__CNR_OPEN_LOOP_POSVEL_CONTROLLER__H
#define CNR_OPEN_LOOP_POSVEL_CONTROLLER__CNR_OPEN_LOOP_POSVEL_CONTROLLER__H
...
# endif  // CNR_OPEN_LOOP_POSVEL_CONTROLLER__CNR_OPEN_LOOP_POSVEL_CONTROLLER__H
